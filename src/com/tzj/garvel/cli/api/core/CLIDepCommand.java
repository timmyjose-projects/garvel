...
public class CLIDepCommand extends CLICommand {
    ...
    public CLIDepCommand(final CLICommandOption opts, final String groupId, final String artifactId, final boolean showDependencies) {
        super(opts);
    ...
    @Override
    public void execute() {
        final DepCommandParams params = new DepCommandParams(groupId, artifactId, showDependencies);
        try {
